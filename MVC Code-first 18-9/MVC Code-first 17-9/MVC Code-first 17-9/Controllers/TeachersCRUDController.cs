...
{
    public class TeachersCRUDController : Controller
    {
        ...
        // GET: TeachersCRUD/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: TeachersCRUD/Create
