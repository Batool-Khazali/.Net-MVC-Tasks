...
namespace MVC_Code_first_19_9.Controllers
{
    public class ClassesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name")] Classes classes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name")] Classes classes)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult Delete(int? id)
        {
            ...
            Classes classes = db.Classes.Include(a => a.subject)
                .Include(b => b.task)
                .Include(c => c.student)
                .FirstOrDefault(a => a.Id == id);
            if (classes == null)
